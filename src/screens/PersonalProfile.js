                        ...
                        <div className="row">
                            <div className="col-lg-3 aside">
                                ...
                                <div className="d-flex align-items-center justify-content-between mb-4">
                                    <Link to="/profiles"><i className=" fas fa-arrow-left" /></Link>
                                ...
                                {/* img  */}
                                <img src="images/profile.png" id="profile-pic" className="img-fluid mb-4" alt="" />
                                {/* active  */}
                                <div className="active mb-4">
                                    <h1 className="mb-3">Active Participating Poll</h1>
                                    <p className="mb-3">Presidential Poll</p>
                                    ...
                                    <div className="d-flex justify-content-between align-items-start disclaimer">
                                        <img src="images/alert-svgrepo-com 1.png" alt="" />
                                        <h6>Votes made on BallotBox are only limited to BallotBox and does not count for the
                                            National Election!</h6>
                                    </div>
                                </div>
                                {/* history  */}
                                <div className="history">
                                    <h1>Participating Poll History</h1>
                            ...
                            <div className="col-lg-9 main">
                                <div id="into-video">
                                    <img src="images/Capture 1.png" className="img-fluid" alt="" />
                                </div>
                                <h1 id="name">Ahmed Bola Tinubu</h1>
                                <div className="body">
                                    <h3>Overview</h3>
                                    <p className="mb-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eleifend nisi,
                                        mauris cras
                                        nec, aliquam nunc quis et proin. Turpis sed eros, scelerisque eget. Urna molestie
                                        adipiscing amet at ac et. Non leo
                                        amet in tempus augue faucibus tortor.
                                        Orci urna, maecenas eget sagittis, at viverra elementum augue natoque. Nunc massa
                                        habitasse pellentesque sagittis eget
                                        pulvinar blandit turpis enim. Consectetur massa porta vel, quis diam faucibus
                                        adipiscing. Dolor, in tellus, commodo
                                        dolor dui dolor.
                                        Quis quis felis mi magna habitasse quis convallis sit tempor. Augue posuere commodo
                                        augue amet, enim. Est scelerisque semper purus vitae morbi varius. Tortor ornare sit
                                        faucibus condimentum. Lorem eu vitae donec fames. Ut bibendum commodo euismod
                                        suscipit vitae. Sed massa sit mauris feugiat habitant volutpat sed lorem eu. Mauris
                                        pellentesque ullamcorper consectetur sapien fames sagittis, placerat iaculis dis.
                                    </p>
                                    <h3>Education</h3>
                                    <p className="mb-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eleifend nisi,
                                        mauris cras
                                        nec, aliquam nunc quis et proin.
                                        Turpis sed eros, scelerisque eget. Urna molestie adipiscing amet at ac et. Non leo
                                        amet in tempus augue faucibus tortor.
                                        Orci urna, maecenas eget sagittis, at viverra elementum augue natoque. Nunc massa
                                        habitasse pellentesque sagittis eget
                                        pulvinar blandit turpis enim. Consectetur massa porta vel, quis diam faucibus
                                    ...
                                    <p className="mb-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eleifend nisi,
                                        ...
                                        pulvinar blandit turpis enim. Consectetur massa porta vel, quis diam faucibus
                                        adipiscing. Dolor, in tellus, commodo
                                        dolor dui dolor.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eleifend
                                        nisi, mauris cras nec, aliquam nunc
                                        quis et proin. Turpis sed eros, scelerisque eget. Urna molestie adipiscing amet at
                                        ac et. Non leo amet in tempus augue
                                        faucibus tortor. Orci urna, maecenas eget sagittis, at viverra elementum augue
                                        natoque. Nunc massa habitasse
                                        pellentesque sagittis eget pulvinar blandit turpis enim. Consectetur massa porta
                                        vel, quis diam faucibus adipiscing.
                                        Dolor, in tellus, commodo dolor dui dolor. Lorem ipsum dolor sit amet, consectetur
                                        adipiscing elit. Eleifend nisi,
                                        mauris cras nec, aliquam nunc quis et proin. Turpis sed eros, scelerisque eget. Urna
                                        molestie adipiscing amet at ac et.
                                        Non leo amet in tempus augue faucibus tortor. Orci urna, maecenas eget sagittis, at
                                        viverra elementum augue natoque.
                                        Nunc massa habitasse pellentesque sagittis eget pulvinar blandit turpis enim.
                                        Consectetur massa porta vel, quis diam
                                        faucibus adipiscing. Dolor, in tellus, commodo dolor dui dolor.</p>
                                    ...
                                    <p className="mb-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eleifend nisi,
                                        ...
                                        quis et proin. Turpis sed eros, scelerisque eget. Urna molestie adipiscing amet at
                                        ac et. Non leo amet in tempus augue
                                        faucibus tortor. Orci urna, maecenas eget sagittis, at viverra elementum</p>
                                    <h3>Activism</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eleifend nisi, mauris cras
                                        nec, aliquam nunc quis et proin.
                                        Turpis sed eros, scelerisque eget. Urna molestie adipiscing amet at ac et. Non leo
                                        amet in tempus augue faucibus tortor.
                                        Orci urna, maecenas eget sagittis, at viverra elementum augue natoque. Nunc massa
                                        habitasse pellentesque sagittis eget
                                        pulvinar blandit turpis enim. Consectetur massa porta vel, quis diam</p>
                                </div>
                                <div className="other-profiles">
                                    <h1>See other profile</h1>
