    ...
    return (
        <div className="container-fluid">
            <div className="header">
                ...
                <div className="container">
                    <div className="search">
                        <h1 className="mb-3">Explore Politics, Learn and Share Insights Online</h1>
                        <div className="search-bar">
                            <input type="text" placeholder="Search for Aspirant or Poll" />
                            <img src="images/search-normal.png" className="img-fluid" alt="search" />
                        </div>
                    </div>
                </div>
                {/* ongoing Poll */}
                <div className="container">
                        ...
                        <div className="d-flex justify-content-between">
                            <div className="d-flex align-items-center">
                                <div className="country d-flex justify-content-between align-items-center">
                                    <img src="images/nigeria (1) 1.png" alt="" />
                                    <i className="fas fa-angle-down" />
                                </div>
                                <p className="mb-0">Ongoing Polls</p>
                            </div>
                            <div className="d-flex justify-content-between align-items-center">
                                <i className="fas fa-share-alt-square share-btn" />
                                <div className="d-flex justify-content-between polls-btn">
                                    <button id="chat"><img src="images/Layer_x0020_1.svg" alt="" />Chart</button>
                                    <button className="active" id="leaderboard"><img src="images/Group 376.svg" alt="" />Leaderboard</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="home-polls">
                        <div className="header">
                            <div className="row home-polls-btn">
                                <div className="col-lg-3 d-flex justify-content-between align-items-center">
                                    <div className="d-flex flex-column align-items-center button">
                                        <p className="mb-0">Presidency</p>
                                        <div className="active-underline mt-2" />
                                    </div>
                                    <div className="poll-btn-border" />
                                </div>
                                <div className="col-lg-3 d-flex justify-content-between align-items-center">
                                    <div className="d-flex flex-column align-items-center button">
                                        <p className="mb-0">Gubernatorial</p>
                                    </div>
                                    <div className="poll-btn-border" />
                                </div>
                                <div className="col-lg-3 d-flex justify-content-between align-items-center">
                                    <div className="d-flex flex-column align-items-center button">
                                        <p className="mb-0">Senatorial</p>
                                    </div>
                                    <div className="poll-btn-border" />
                                </div>
                                <div className="col-lg-3 d-flex justify-content-between align-items-center">
                                    <div className="d-flex flex-column align-items-center button">
                                        <p className="mb-0">House of Represenatative</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="polls">
                            <div className="header">
                                <h1>2023 Presidential Poll</h1>
                                <div className="d-flex justify-content-between">
                                    <p>2,029,209 Total Polls</p>
                                    <p>See all Polls<i className="fas fa-angle-right" /></p>
                                </div>
                            </div>
                                ...
                                <div className="candidate mb-4">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-7 d-flex flex-column">
                                            <h1>Mike Jakande</h1>
                                            <p className="mb-2">Abundant Nigeria Renewal Party</p>
                                        ...
                                        <div className="col-lg-2">
                                            <div id="votes">
                                                <h1 className="mb-4">24%</h1>
                                                <p>487,010 Votes</p>
                                            </div>
                                        </div>
                                        <div className="col-lg-1">
                                            <div className="d-flex justify-content-center align-items-center" id="vote">
            ...
            <div className="end-section">
                <div className="container">
                    {/* enroll  */}
                    <div className="enroll row align-items-center">
                        <div className="col-lg-6">
                            <h1 className="mb-4">Enroll Now for your Permanent Voters Card (PVC)</h1>
                            <p className="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam vitae dignissim
                                ...
                                a risus eu diam eget ac.</p>
                            <button className="d-flex align-items-center">Enroll with any of our Partners<i className="fas fa-angle-right" /></button>
                        </div>
                        <div className="col-lg-6 d-flex justify-content-end">
                            <div className="enroll-pvc-container">
                                <img src="images/_100393795__99730322_bbc 1.png" className="img-fluid" alt="" />
